...
# def warmup(args, subgraphs, encoder_model, contrast_model, optimizer, device, edges):
#     encoder_model.train()
#     total_loss = 0
#     optimizer.zero_grad()
#     (z, z1, z2) = encoder_model(args, subgraphs, edges=False)
    # h1, h2 = [encoder_model.project(x) for x in [z1, z2]]
    # h1, h2 = z1, z2
    # loss = contrast_model(h1, h2, neg_mask=subgraphs.neg_mask)
    # loss.backward()
    # optimizer.step()
